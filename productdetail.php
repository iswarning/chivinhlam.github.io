<?php
	...
	{
		$id = preg_replace("#[^0-9]#i", '', $_GET['MaSanPham']);
...
<div class="container">
	<div class="row">
			...
			<article>
				<div class="img-big-wrap">
					<div class="img-zoom-container">
						<img class="img-fluid" id="myimage" src="<?php echo $image ?>">
					</div>
				</div>
		...
		<div class="col-md-7" style="padding-left: 50px">
			<form action="shoppingcart.php?action=add&MaSanPham=<?php echo $id; ?>" method="POST">
				...
				<h4 class="price">Giá hiện tại: <span style="color:red;"><?php echo $gia; ?>đ</span></h4>
				<p class="vote">
					2 KHUYẾN MÃI<br>
